---
title: "How to Create an About Page That Wins Customers"
date: 2025-02-18
category: Web Design
...
ogDescription: "Your About page is one of the most visited pages on your site. Make it work for you with these practical tips."
ogImage: https://thomaspublishinghouse.com/assets/images/team-editorial.webp
schema: |
  {
    "@context": "https://schema.org",
    "@type": "BlogPosting",
    "headline": "How to Create an About Page That Wins Customers",
    "description": "How to write an About page that builds trust and converts visitors.",
    ...
    "mainEntityOfPage": { "@type": "WebPage", "@id": "https://thomaspublishinghouse.com/blog/about-page-that-wins-customers/" }
  }
---
...
A face and a name [build trust](/blog/building-trust-online/) faster than any amount of marketing copy.
...
- **A standout [testimonial](/blog/social-proof-testimonials-website/)** — One strong quote from a happy client
...
- "Ready to work with us? [Get a free quote](/contact.html)"
- "See what we've built: [View our portfolio](/portfolio.html)"
- "Have questions? [Let's talk](/contact.html)"
...
1. **Hero section** — Headline: "We Build Websites That Actually Grow Your Business" + subheadline that speaks to the customer's need
2. **The problem** — 2-3 sentences about the frustration small businesses face
3. **Your solution** — How your business specifically addresses that frustration
4. **Team section** — Photos, names, and one-line bios
5. **By the numbers** — Key stats in a visual layout
6. **Testimonial** — One impactful quote
5. **[CTA](/blog/calls-to-action-that-convert/)** — "Let's build something together" with a button to the contact page
...
**Need help making your website work harder?** [Get in touch](/contact.html) — we'll help you create pages that connect with your audience and drive results.
