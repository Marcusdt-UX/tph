---
title: "Web Accessibility: What Small Businesses Need to Know"
date: 2024-06-18
category: Web Design
...
ogDescription: "Web accessibility isn't just about compliance. It's about reaching every potential customer."
ogImage: https://thomaspublishinghouse.com/assets/images/office-modern.webp
schema: |
  {
    "@context": "https://schema.org",
    "@type": "BlogPosting",
    "headline": "Web Accessibility: What Small Businesses Need to Know",
    "description": "A practical guide to web accessibility for small businesses.",
    "image": "https://thomaspublishinghouse.com/assets/images/office-modern.webp",
    ...
    "mainEntityOfPage": { "@type": "WebPage", "@id": "https://thomaspublishinghouse.com/blog/web-accessibility-small-businesses/" }
  }
---
...
### It's Good for SEO
Many accessibility best practices overlap with [SEO best practices](/blog/seo-basics-local-businesses/). Alt text on images, proper heading structure, descriptive link text, and semantic HTML all help search engines understand your content better.
...
### Low Color Contrast
Light gray text on a white background might look sleek, but it's unreadable for anyone with low vision. Text should have a **contrast ratio of at least 4.5:1** against its background. (For more on choosing colors wisely, see our guide to [color psychology in web design](/blog/color-psychology-web-design/).)

**Fix:** Use a contrast checker tool like [WebAIM's Contrast Checker](https://webaim.org/resources/contrastchecker/) to test your color combinations.
...
1. **Add alt text to all images** — Describe what the image shows
2. **Use proper heading hierarchy** — H1, H2, H3 in order, never skip levels
3. **Make links descriptive** — "Learn more about our services" instead of "click here"
4. **Ensure sufficient color contrast** — Test with a contrast checker
5. **Make your site keyboard-navigable** — Test by tabbing through your pages
6. **Use legible font sizes** — Minimum 16px for body text
7. **Add focus indicators** — Visible outlines on focused elements for keyboard users
...
**Want an accessibility review of your website?** [Contact us](/contact.html) — we'll identify the biggest issues and help you build a more inclusive online presence.
